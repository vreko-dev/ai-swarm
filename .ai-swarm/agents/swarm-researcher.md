...
If this exits non-zero: STOP. Never work directly on `main` without a spec. Surface to conductor immediately.
...
- Import rules from `.ai-swarm/docs/reference/architecture-fence.txt`
- Registration point requirements
- Thin client rules
- Canonical file locations

### Anti-Patterns (failure modes with examples)
- Each entry from `.ai-swarm/docs/reference/anti-patterns.md`
...
## HOW TO DOCUMENT:
Record findings in `.ai-swarm/knowledge/` as markdown files. Each file should contain:
